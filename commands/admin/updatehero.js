...
module.exports = {
    ...
    data: new SlashCommandBuilder()
        ...
        .addStringOption(option => option.setName('option').setDescription('Champ à modifier').addChoices({
            name: 'Nom',
            value: 'name'
        }, {name: 'Elément', value: 'element'}, {
            name: 'Nombre d\'étoiles',
            value: 'nb_stars'
        }, {name: 'Lien du message', value: 'message_link'}, {name: 'image', value: 'image'}).setRequired(true))
